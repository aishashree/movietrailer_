...
jurassic_world = media.Movie(
    "Jurassic_World", "A story of animals",
...
movies = [mickey_mouse, jumanji, angry_birds,
          spykids, finding_nemo, jurassic_world, art]
